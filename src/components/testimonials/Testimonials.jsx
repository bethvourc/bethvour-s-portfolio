...
const data = [
  ...
  },
  {
    ...
    name: "Jane Doe 1",
    review:
      "We worked closely in a team over a periode of four months, and I couldn't have asked for a better partner! Bethvour is extremely dedicated, and always askes the right questions in order to be on the right track.",
  },
  {
    avatar: AVTR3,
    name: "Jane Doe 2",
